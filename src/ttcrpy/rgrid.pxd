...
cdef extern from "Grid3Drnfs.h" namespace "ttcr" nogil:
    cdef cppclass Grid3Drnfs[T1,T2](Grid3Drn[T1,T2,Node3Dn[T1,T2]]):
        Grid3Drnfs(T2, T2, T2, T1, T1, T1, T1, T1, T1, T1, int, bool, bool,
...
cdef extern from "Grid3Drnfs_OpenCL.h" namespace "ttcr" nogil:
    cdef cppclass Grid3Drnfs_OpenCL[T1,T2](Grid3Drn[T1,T2,Node3Dn[T1,T2]]):
        Grid3Drnfs_OpenCL(T2, T2, T2, T1, T1, T1, T1, T1, T1, T1, int, bool,
                          bool, bool, size_t, bool) except +
...
cdef extern from "Grid3Drcfs.h" namespace "ttcr" nogil:
    cdef cppclass Grid3Drcfs[T1,T2](Grid3Drn[T1,T2,Node3Dn[T1,T2]]):
        Grid3Drcfs(T2, T2, T2, T1, T1, T1, T1, T1, T1, T1, int, bool, bool,
                   bool, size_t, bool) except +
...
cdef extern from "Grid3Drcfs_OpenCL.h" namespace "ttcr" nogil:
    cdef cppclass Grid3Drcfs_OpenCL[T1,T2](Grid3Drn[T1,T2,Node3Dn[T1,T2]]):
        Grid3Drcfs_OpenCL(T2, T2, T2, T1, T1, T1, T1, T1, T1, T1, int, bool,
                          bool, bool, size_t, bool) except +
