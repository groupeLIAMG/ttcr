...
//  ttcr
//
//  Static 2-D (x-z plane) nearest-neighbour index over the nodes of an
//  unstructured or rectilinear grid, used to accelerate point location and
//  on-node lookups.
//
...
namespace ttcr {
    ...
    public:
        ...
        NodeKDTree2D(const NodeKDTree2D&) = delete;
        NodeKDTree2D& operator=(const NodeKDTree2D&) = delete;

        // Grid index of the node closest to (x, z).
