...
namespace ttcr {
     ...
     * @sa Grid3Duc.h, Metric.h, Grid2Ducfs.h, Grid3Ducfm.h
     */
    class Grid3Ducfs : public Grid3Duc<T1,T2,Node3Dc<T1,T2>,CELL> {
    public:
        /**
    ...
    template<typename T1, typename T2, typename CELL>
    void Grid3Ducfs<T1,T2,CELL>::initOrdering(const std::vector<sxyz<T1>>& refPts,
                                         const int order) {
    ...
    template<typename T1, typename T2, typename CELL>
    void Grid3Ducfs<T1,T2,CELL>::raytrace(const std::vector<sxyz<T1>>& Tx,
                                     const std::vector<T1>& t0,
                                     const std::vector<sxyz<T1>>& Rx,
    ...
    template<typename T1, typename T2, typename CELL>
    void Grid3Ducfs<T1,T2,CELL>::initTx(const std::vector<sxyz<T1>>& Tx,
                                   const std::vector<T1>& t0,
